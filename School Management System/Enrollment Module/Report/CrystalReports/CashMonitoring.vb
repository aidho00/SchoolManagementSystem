...
Public Class CashMonitoring
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SchoolManagementSystem.CashMonitoring.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCashMonitoring
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CashMonitoring = New CashMonitoring()
        rpt.Site = Me.Site
        Return rpt
    End Function
