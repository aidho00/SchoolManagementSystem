...
Public Class CashMonitoring2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SchoolManagementSystem.CashMonitoring2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCashMonitoring2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CashMonitoring2 = New CashMonitoring2()
        rpt.Site = Me.Site
        Return rpt
    End Function
