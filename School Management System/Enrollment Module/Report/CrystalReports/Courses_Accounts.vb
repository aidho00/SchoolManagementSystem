...
Public Class Courses_Accounts
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SchoolManagementSystem.Courses_Accounts.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCourses_Accounts
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Courses_Accounts = New Courses_Accounts()
        rpt.Site = Me.Site
        Return rpt
    End Function
