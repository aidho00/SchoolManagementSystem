...
Public Class E_nrolled_Student
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SchoolManagementSystem.E_nrolled_Student.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedE_nrolled_Student
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As E_nrolled_Student = New E_nrolled_Student()
        rpt.Site = Me.Site
        Return rpt
    End Function
