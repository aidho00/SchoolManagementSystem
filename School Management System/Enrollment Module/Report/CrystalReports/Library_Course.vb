...
Public Class Library_Course
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SchoolManagementSystem.Library_Course.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLibrary_Course
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Library_Course = New Library_Course()
        rpt.Site = Me.Site
        Return rpt
    End Function
