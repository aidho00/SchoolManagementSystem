...
Public Class Library_Course_HS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SchoolManagementSystem.Library_Course_HS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLibrary_Course_HS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Library_Course_HS = New Library_Course_HS()
        rpt.Site = Me.Site
        Return rpt
    End Function
