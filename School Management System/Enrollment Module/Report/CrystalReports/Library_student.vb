...
Public Class Library_student
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SchoolManagementSystem.Library_student.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLibrary_student
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Library_student = New Library_student()
        rpt.Site = Me.Site
        Return rpt
    End Function
