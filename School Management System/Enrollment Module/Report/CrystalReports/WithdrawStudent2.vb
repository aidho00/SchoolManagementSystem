...
Public Class WithdrawStudent2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SchoolManagementSystem.WithdrawStudent2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedWithdrawStudent2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As WithdrawStudent2 = New WithdrawStudent2()
        rpt.Site = Me.Site
        Return rpt
    End Function
