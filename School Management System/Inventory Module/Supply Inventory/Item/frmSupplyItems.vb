...
Public Class frmSupplyItems
    ...
    Private Sub dgSupplyItemList_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgSupplyItemList.CellContentClick
        ...
        If colname = "colUpdate" Then
            ...
            frmSupplyItemAdd.cbSupplySize.Text = dgSupplyItemList.Rows(e.RowIndex).Cells(4).Value.ToString
            frmSupplyItemAdd.txtSupplyDesc.Text = dgSupplyItemList.Rows(e.RowIndex).Cells(2).Value.ToString
            frmSupplyItemAdd.txtPrice.Text = dgSupplyItemList.Rows(e.RowIndex).Cells(5).Value.ToString
            frmSupplyItemAdd.CategoryID = CInt(dgSupplyItemList.Rows(e.RowIndex).Cells(6).Value)
            frmSupplyItemAdd.SizeID = CInt(dgSupplyItemList.Rows(e.RowIndex).Cells(7).Value)
            frmSupplyItemAdd.txtOpeningStock.Text = dgSupplyItemList.Rows(e.RowIndex).Cells(8).Value.ToString
            frmSupplyItemAdd.txtReOrderPoint.Text = dgSupplyItemList.Rows(e.RowIndex).Cells(9).Value.ToString
            frmSupplyItemAdd.cbSupplyType.Text = dgSupplyItemList.Rows(e.RowIndex).Cells(10).Value.ToString
