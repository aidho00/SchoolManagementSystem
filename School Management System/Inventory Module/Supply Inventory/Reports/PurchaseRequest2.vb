...
Public Class PurchaseRequest2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SchoolManagementSystem.PurchaseRequest2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_requestno() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_requestremarks() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedPurchaseRequest2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PurchaseRequest2 = New PurchaseRequest2()
        rpt.Site = Me.Site
        Return rpt
    End Function
