...
Public Class Supply_AllRequest
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SchoolManagementSystem.Supply_AllRequest.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSupply_AllRequest
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Supply_AllRequest = New Supply_AllRequest()
        rpt.Site = Me.Site
        Return rpt
    End Function
