...
Public Class Supply_Inventory_2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SchoolManagementSystem.Supply_Inventory_2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSupply_Inventory_2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Supply_Inventory_2 = New Supply_Inventory_2()
        rpt.Site = Me.Site
        Return rpt
    End Function
