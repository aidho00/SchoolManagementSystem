...
Public Class Supply_Ledger
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SchoolManagementSystem.Supply_Ledger.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSupply_Ledger
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Supply_Ledger = New Supply_Ledger()
        rpt.Site = Me.Site
        Return rpt
    End Function
