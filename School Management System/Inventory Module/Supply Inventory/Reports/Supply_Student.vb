...
Public Class Supply_Student
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SchoolManagementSystem.Supply_Student.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSupply_Student
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Supply_Student = New Supply_Student()
        rpt.Site = Me.Site
        Return rpt
    End Function
