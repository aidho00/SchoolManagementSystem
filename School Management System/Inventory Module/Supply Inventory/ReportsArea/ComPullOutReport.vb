...
Public Class ComPullOutReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SchoolManagementSystem.ComPullOutReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedComPullOutReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ComPullOutReport = New ComPullOutReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
