...
Public Class DefectReport2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SchoolManagementSystem.DefectReport2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDefectReport2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DefectReport2 = New DefectReport2()
        rpt.Site = Me.Site
        Return rpt
    End Function
