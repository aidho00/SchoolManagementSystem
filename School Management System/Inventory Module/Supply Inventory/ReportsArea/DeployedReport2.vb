...
Public Class DeployedReport2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SchoolManagementSystem.DeployedReport2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_office_location() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedDeployedReport2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DeployedReport2 = New DeployedReport2()
        rpt.Site = Me.Site
        Return rpt
    End Function
