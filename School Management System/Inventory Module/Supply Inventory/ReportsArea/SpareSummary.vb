...
Public Class SpareSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SchoolManagementSystem.SpareSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSpareSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SpareSummary = New SpareSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
