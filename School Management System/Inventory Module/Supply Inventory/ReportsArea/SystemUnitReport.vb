...
Public Class SystemUnitReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SchoolManagementSystem.SystemUnitReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSystemUnitReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SystemUnitReport = New SystemUnitReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
