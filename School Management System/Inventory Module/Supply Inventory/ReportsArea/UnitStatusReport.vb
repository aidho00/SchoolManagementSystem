...
Public Class UnitStatusReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SchoolManagementSystem.UnitStatusReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_labname() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedUnitStatusReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As UnitStatusReport = New UnitStatusReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
